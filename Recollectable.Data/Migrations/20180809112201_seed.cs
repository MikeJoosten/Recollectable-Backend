...
namespace Recollectable.Data.Migrations
{
    public partial class seed : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Collectables",
                columns: new[] { "Id", "CollectorValueId", "CountryId", "Discriminator", "ReleaseDate", "Coin_BackImagePath", "Designer", "EdgeLegend", "EdgeType", "Coin_FaceValue", "Coin_FrontImagePath", "Coin_HeadOfState", "Metal", "MintMark", "Mintage", "Note", "Coin_ObverseDescription", "ObverseInscription", "ObverseLegend", "Coin_ReverseDescription", "ReverseInscription", "ReverseLegend", "Coin_Size", "Subject", "Coin_Type", "Weight" },
                values: new object[] { new Guid("14db50bc-7b1a-4b65-8d6f-bf5e3412c610"), new Guid("3ba282c2-4648-49f1-83ad-045ed612f31a"), new Guid("406b1c0f-5505-43eb-a780-6ae1b72cf91b"), "Coin", "1957", null, "Manuel L. Negrete", "INDEPENCIA Y LIBERTAD", null, 5, null, "Adolfo Ruiz Cortines", "0.720 Silver 0.4151 oz. ASW", "Mo.", 200000, null, "National arms, eagle left", null, null, "Head left", null, null, "36 mm.", "100th Anniversary of Constitution", "Pesos", "18.05 g." });

            migrationBuilder.InsertData(
                table: "Collectables",
                columns: new[] { "Id", "CollectorValueId", "CountryId", "Discriminator", "ReleaseDate", "BackImagePath", "Color", "FaceValue", "FrontImagePath", "HeadOfState", "ObverseDescription", "ReverseDescription", "Signature", "Size", "Type", "Watermark" },
                values: new object[] { new Guid("4c8e3fe4-aa96-4c33-9e4e-7ab284a653d5"), new Guid("08aeaba0-a480-4dd8-b7be-8215ddb7fca4"), new Guid("e8a1c283-2300-4f3f-b408-59d0f8ccd893"), "Banknote", "1988", null, "Pink on multicolor underprint", 1000, null, "Queen Elizabeth II", "Queen Elizabeth II, Parliament Library at right, Optical device with denomination at upper left, Arms at upper left center", "Pine grosbeak on branch at right", "Thiessen-Crow", null, "Dollars", null });

            migrationBuilder.InsertData(
                table: "Collectables",
                columns: new[] { "Id", "CollectorValueId", "CountryId", "Discriminator", "ReleaseDate", "Coin_BackImagePath", "Designer", "EdgeLegend", "EdgeType", "Coin_FaceValue", "Coin_FrontImagePath", "Coin_HeadOfState", "Metal", "MintMark", "Mintage", "Note", "Coin_ObverseDescription", "ObverseInscription", "ObverseLegend", "Coin_ReverseDescription", "ReverseInscription", "ReverseLegend", "Coin_Size", "Subject", "Coin_Type", "Weight" },
                values: new object[] { new Guid("4e6b10c3-0758-4a33-9b10-861d23b57ac2"), new Guid("26aabce7-03cb-470f-9e4e-2d65095a37c9"), new Guid("18d9e209-e798-44ed-bf2e-65798f8717c0"), "Coin", "2009", null, null, null, null, 1, null, "Rafael Correa", "0.999 Silver 0.9925 oz. ASW", null, 200, null, null, null, null, null, null, null, "39 mm.", "Independence 200th Anniversary", "Sucre", "31.10 g." });

            migrationBuilder.InsertData(
                table: "Collectables",
                columns: new[] { "Id", "CollectorValueId", "CountryId", "Discriminator", "ReleaseDate", "BackImagePath", "Color", "FaceValue", "FrontImagePath", "HeadOfState", "ObverseDescription", "ReverseDescription", "Signature", "Size", "Type", "Watermark" },
                values: new object[] { new Guid("ad95d611-1778-4f9d-990f-ded3c914d7b1"), new Guid("e92b30b7-5a08-41aa-8407-f10b6efa1571"), new Guid("5626595c-a6b1-44ba-b60d-87b5b35fe208"), "Banknote", "1993", null, null, 50, null, "Bill Clinton", "Ulysses S. Grant at center", "United States Capital Building", null, null, "Dollars", null });

            migrationBuilder.InsertData(
                table: "Collectables",
                columns: new[] { "Id", "CollectorValueId", "CountryId", "Discriminator", "ReleaseDate", "Coin_BackImagePath", "Designer", "EdgeLegend", "EdgeType", "Coin_FaceValue", "Coin_FrontImagePath", "Coin_HeadOfState", "Metal", "MintMark", "Mintage", "Note", "Coin_ObverseDescription", "ObverseInscription", "ObverseLegend", "Coin_ReverseDescription", "ReverseInscription", "ReverseLegend", "Coin_Size", "Subject", "Coin_Type", "Weight" },
                values: new object[] { new Guid("db0c31f2-5707-4111-8cb5-87f9201e7941"), new Guid("8bf1ae62-5493-4e08-83b8-65bf9c267c32"), new Guid("5626595c-a6b1-44ba-b60d-87b5b35fe208"), "Coin", "1924", null, "Adolph A. Weinman", null, null, 1, null, "Calvin Coolidge", "0.900 Silver 0.0723 oz. ASW", null, 24010000, null, null, null, null, null, null, null, "17.8 mm.", null, "Dime", "2.5 g." });
